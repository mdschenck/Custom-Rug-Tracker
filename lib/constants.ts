...
export const STATUS_COLORS: Record<QuoteStatus, { bg: string; text: string }> = {
  ...
  'CAD Approval Pending': { bg: 'bg-red-100', text: 'text-red-700' },
  'CAD Approved': { bg: 'bg-violet-100', text: 'text-violet-700' },
  ...
  'Swatch Approval Pending': { bg: 'bg-red-100', text: 'text-red-700' },
